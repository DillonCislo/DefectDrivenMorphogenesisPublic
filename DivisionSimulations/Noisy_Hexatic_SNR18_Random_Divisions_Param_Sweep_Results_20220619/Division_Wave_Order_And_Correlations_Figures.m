...
%
%   In particular this script will generate Fig. S19A
%
...
% This section is necessary to convert the raw simulation results into the
% relevant fields needed for visualization. Skip this section if you just
% download the results from the Dryad repository.
close all; clc;
...
% Load results
dataFile = fullfile(projectDir, 'Simulation_Result_Fields_22-Jun-2022.mat');
load(dataFile);
...
% Plot tissue widths
% plot( tissueWidth(1) .* [1 1], yLim, ':', ...
%     'LineWidth', 1.5, 'Color', t1Plot.Color );
% plot( tissueWidth(161) .* [1 1], yLim, ':', ...
%     'LineWidth', 1.5, 'Color', t161Plot.Color );
% plot( tissueWidth(234) .* [1 1], yLim, ':', ...
%     'LineWidth', 1.5, 'Color', t234Plot.Color );
% plot( mean(tissueWidth([161 234])) .* [1 1], [yLim(1) 0.8*yLim(2)], ...
%     ':k', 'LineWidth', 1.5 );

% Plot tissue lengths
% plot( tissueLength(1) .* [1 1], yLim, ':', ...
%     'LineWidth', 1.5, 'Color', t1Plot.Color );
% plot( tissueLength(161) .* [1 1], yLim, ':', ...
%     'LineWidth', 1.5, 'Color', t161Plot.Color );
% plot( tissueLength(234) .* [1 1], yLim, ':', ...
%     'LineWidth', 1.5, 'Color', t234Plot.Color );


% Plot algebraic decay guide line
% plot(r, 0.25 .* r.^(-1/4), '--k', 'LineWidth', 1.5);
...
% plot( tissueLength(234) .* [1 1], yLim, ':', ...
%     'LineWidth', 1.5, 'Color', t234Plot.Color );
% plot( mean(tissueLength([161 234])) .* [1 1], [yLim(1) 0.8*yLim(2)], ...
%     ':k', 'LineWidth', 1.5 );
